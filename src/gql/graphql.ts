...
export function useAllPlanetsQuery(
   baseOptions?: Apollo.QueryHookOptions<AllPlanetsQuery, AllPlanetsQueryVariables>,
) {
...
export function useAllPlanetsLazyQuery(
   baseOptions?: Apollo.LazyQueryHookOptions<AllPlanetsQuery, AllPlanetsQueryVariables>,
) {
   const options = { ...defaultOptions, ...baseOptions }
